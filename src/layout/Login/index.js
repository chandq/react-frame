    ...
    return (
      <>
        <div className="login" style={{ background: `url(${bgimg}) 50% 50% / cover` }}>
          <div>
            <img src={require('@/assets/images/Funny00003.png')}></img>
          </div>
          <div>
            <i className="iconfont icon-changjingguanli" />
            <span className="myheader">您好朋友，请登录。</span>
          </div>
          <Form onSubmit={this.handleSubmit} className="login-form" style={{ minWidth: 120 }}>
            <Form.Item>
            ...
            <Form.Item>
              <Button
                style={{ width: '5vw', minWidth: 70, fontWeight: 'bold' }}
                type="primary"
                htmlType="submit"
